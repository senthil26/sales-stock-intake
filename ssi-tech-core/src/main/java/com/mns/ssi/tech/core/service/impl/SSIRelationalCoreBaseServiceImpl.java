...
public abstract class SSIRelationalCoreBaseServiceImpl implements SSIRelationalCoreBaseService {
	...
	public <T extends SSIBaseEntity> List<T> findFieldIds(Class<T> entityClass, String searchField,
			List<Object> filedValues, boolean isNegative) {
